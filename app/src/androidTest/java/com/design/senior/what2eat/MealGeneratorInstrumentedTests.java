...
public class MealGeneratorInstrumentedTests {
    ...
    public void testMealGeneratorSetters() throws Exception {
        ...
        Assert.assertTrue(generator.getAllowedDiet().equals(DietType.NONE));
        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.PALEO));
        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.PESCETARIAN));
        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.VEGAN));
        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.VEGETARIAN));

        generator.setAllowedDiet(DietType.PALEO);
        generator.setAllowedDiet(DietType.PESCETARIAN);

        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.NONE));
        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.PALEO));
        Assert.assertTrue(generator.getAllowedDiet().equals(DietType.PESCETARIAN));
        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.VEGAN));
        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.VEGETARIAN));

        generator.setAllowedDiet(DietType.VEGAN);

        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.NONE));
        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.PALEO));
        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.PESCETARIAN));
        Assert.assertTrue(generator.getAllowedDiet().equals(DietType.VEGAN));
        Assert.assertFalse(generator.getAllowedDiet().equals(DietType.VEGETARIAN));
        ...
        generator.setDisallowedAllergies(allergyTypes);
        generator.setAllowedDiet(DietType.NONE);
        ...
        generator.removeDisallowedAllergy(AllergyType.EGGS);
        generator.removeDisallowedAllergy(AllergyType.FISH);
        generator.removeDisallowedAllergy(AllergyType.PEANUTS);
    ...
    public void testMealGeneratorGeneration() throws Exception {
        ...
        breakfast1.setDietTypeEnum(DietType.NONE);
        ...
        breakfast2.setDietTypeEnum(DietType.NONE);
        ...
        breakfast3.setDietTypeEnum(DietType.NONE);
        ...
        breakfast4.setDietTypeEnum(DietType.NONE);
        ...
        breakfast5.setDietTypeEnum(DietType.NONE);
